...
#define STRING_CONFIG_H_AUTHOR "(Arno, customized config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 142.66
  #define DEFAULT_bedKi 18.34
  #define DEFAULT_bedKd 739.69
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38.5, -8, 0 }
